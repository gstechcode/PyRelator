...
class functions(s.settings):
    ...
    def captFront(self):
        ...
        t.sleep(2)
        p.screenshot(region=(300,80,793,482)).save(os.environ["USERPROFILE"] + "\\Documents\\PyRelator\\Images\\tmp\\7F.png")
        t.sleep(1)
        #captura essa foto
    def captBack(self):
        p.moveTo(700,321)
    ...
    def Selfie(self, name):
        p.screenshot(region=(300,80,793,587)).save(os.environ["USERPROFILE"] + "\\Documents\\PyRelator\\Images\\tmp\\" + name + ".png")
